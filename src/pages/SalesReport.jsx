      ...
      <div className="flex items-center justify-between mb-4">
        ...
        <div className="flex items-center gap-2 text-sm">
          ...
          <select
            ...
            className="px-2 py-1 border rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
          >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 mb-4">
        <div className="bg-white shadow rounded-xl p-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-lg font-bold">${salesData.reduce((a, b) => a + b.revenue, 0)}</p>
          </div>
        </div>
        <div className="bg-white shadow rounded-xl p-4 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-lg font-bold">{salesData.reduce((a, b) => a + b.sales, 0)}</p>
          </div>
        </div>
        <div className="bg-white shadow rounded-xl p-4 flex items-center gap-3">
